const projects = [
  ...
  },
  {
    ...
    problem: "Working with legacy internal systems required repetitive navigation, manual data lookup, and inefficient UI workflows, slowing down development and QA processes.",
    solution: "Developed a set of browser-based enhancements (via userscripts) to streamline interaction with legacy systems. These tools improved navigation, reduced repetitive steps, and added contextual UI actions directly within existing platforms.",
    result: "Significantly reduced time spent navigating systems and performing repetitive actions during development and QA workflows.",
    impact: "Used internally to improve team efficiency and reduce friction when working across multiple tools and legacy interfaces.",
