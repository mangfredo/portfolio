...
export default function Infrastructure() {
  return (
    <section id="infrastructure" className="py-28 px-8" style={{ background: "color-mix(in srgb, var(--card-bg) 30%, transparent)" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-8">
          {infra.map((item) => (
            <div key={item.label} className="p-8 rounded-xl border text-center" style={{ background: "var(--card-bg)", borderColor: "var(--card-border)" }}>
